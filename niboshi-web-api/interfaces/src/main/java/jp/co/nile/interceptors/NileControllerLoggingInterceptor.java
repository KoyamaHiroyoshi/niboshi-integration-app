package jp.co.nile.interceptors;
...
@Slf4j
public class NileControllerLoggingInterceptor implements HandlerInterceptor {
  private static final String START_TIME_ATTR_NAME = "NILE_CONTROLLER_START_TIME";
